...
define('main/nav_service',['angularAMD'], function (angularAMD) {
  'use strict';
...
define('common',['angularAMD','angular','angular-ui-router','angular-resource','main/nav_service'], function (angularAMD) {
  'use strict';
  return angularAMD;
});

define('app',['common'], function (angularAMD) {
  'use strict';
